...
for m in 1 2 3 4 5; do
    ...
    # python generate_queries_vary_m.py --dataset=${DATASET} --m=${m} --fdist=${FDIST} --k=5
    # python generate_queries_vary_m.py --dataset=${DATASET} --m=${m} --fdist=${FDIST} --k=10
    # python generate_queries_vary_m.py --dataset=${DATASET} --m=${m} --fdist=${FDIST} --k=15
    python generate_queries_vary_m.py --dataset=${DATASET} --m=${m} --fdist=${FDIST} --k=20 --target=1000
    # python generate_queries_vary_m.py --dataset=${DATASET} --m=${m} --fdist=${FDIST} --k=25
done